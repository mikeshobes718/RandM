        ...
        <div className="relative mx-auto grid max-w-7xl gap-16 lg:grid-cols-[minmax(0,1fr)_minmax(0,480px)] lg:items-center">
          <div className="space-y-10">
            ...
            <div className="inline-flex items-center gap-3 rounded-full border border-indigo-200 bg-indigo-100 px-5 py-2 text-xs font-semibold text-indigo-700">
              ...
              <span className="uppercase tracking-[0.3em]">Trusted by businesses nationwide</span>
            </div>
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="mt-6 text-xl text-slate-600 max-w-3xl mx-auto">
              Send a branded email, post a QR code, and track responses in real time.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Link your Google Profile in seconds. We generate custom QR codes and enable branded review requests for your store.",
              },
              {
                number: "2",
                title: "Capture customer data",
                description: "Customers scan in-store. We capture contact info and route them to the perfect feedback experience.",
              },
              {
                number: "3",
