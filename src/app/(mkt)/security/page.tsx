      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid gap-8 md:grid-cols-3 mb-12">
          {CONTROLS.map((control) => (
            <div key={control.title} className="surface-card p-8 rounded-[32px] flex flex-col h-full transition-transform hover:-translate-y-1">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="surface-card p-10 rounded-[40px] bg-brand/5 border-brand/10 text-center">
