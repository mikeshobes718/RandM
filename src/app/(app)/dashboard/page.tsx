      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
        <div className="flex items-center gap-5">
          ...
          <div className="flex flex-wrap gap-2 items-center">
            <div className="hidden lg:flex items-center gap-2 px-3 py-1.5 bg-emerald-50 border border-emerald-100 rounded-full mr-2">
            ...
            <Link href="/settings" className="inline-flex items-center justify-center w-10 h-10 bg-white text-slate-400 border border-slate-200 rounded-xl transition-all hover:bg-slate-50 hover:text-slate-600 hover:border-slate-300 hover:scale-[1.02] active:scale-[0.98] shadow-sm" title="Settings">
